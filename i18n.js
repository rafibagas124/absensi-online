...
(function (global) {
    ...
    const EN = {
        ...
        "Pengingat AbsensiPro": "AbsensiPro Reminder",
        "Pengingat: Anda memiliki Shift": "Reminder: Your Shift",
        "Silakan siapkan Absen Masuk.": "Please prepare to clock in.",
        "waktu Absen Pulang Shift": "clock-out time for Shift",
        "sudah mendekat. Jangan lupa Absen Pulang.": "is approaching. Do not forget to clock out.",
        "Tidak ada data izin/cuti pada bulan ini untuk diunduh.": "No leave/time-off data this month to download.",
        "s/d": "to",
        "hari": "day(s)",
        ...
        // --- Security Logs & Audits (Log Keamanan) ---
        "Log Keamanan": "Security Logs",
        "Log Keamanan & Audit Real-Time": "Security Logs & Real-Time Audit",
        "Pemantauan otomatis terhadap aktivitas mencurigakan, percobaan brute force, pelanggaran geofencing, dan kegagalan autentikasi.": "Automated monitoring of suspicious activities, brute force attempts, geofencing violations, and authentication failures.",
        "Refresh Log": "Refresh Logs",
        "Bersihkan Log Lokal": "Clear Local Logs",
        "Status Keamanan Sistem": "System Security Status",
        "Dilindungi": "Protected",
        "Rate Limit & CSP Aktif": "Rate Limit & CSP Active",
        "Total Event Terekam": "Total Recorded Events",
        "Peringatan / Alert": "Warnings / Alerts",
        "Konfigurasi Notifikasi Alert Real-Time (Discord / Telegram / Slack & Sentry)": "Real-Time Alert Notification Configuration (Discord / Telegram / Slack & Sentry)",
        "Kirim notifikasi instan ke channel admin jika terjadi anomali (brute-force login, spike kegagalan, dsb).": "Send instant notifications to admin channel upon anomalies (brute-force login, failure spikes, etc.).",
        "Webhook URL (Discord / Slack / Telegram)": "Webhook URL (Discord / Slack / Telegram)",
        "Mendukung Discord Webhook, Slack Webhook, atau custom HTTP payload endpoint.": "Supports Discord Webhooks, Slack Webhooks, or custom HTTP payload endpoints.",
        "Sentry DSN (Opsional)": "Sentry DSN (Optional)",
        "Simpan DSN": "Save DSN",
        "Test Alert": "Test Alert",
        "Pemantauan error & log server cloud realtime menggunakan Sentry.": "Real-time error & cloud server log monitoring using Sentry.",
        "Daftar Aktivitas & Audit Keamanan": "Security Activity & Audit List",
        "Waktu": "Time",
        "Tipe Event": "Event Type",
        "Tingkat Bahaya": "Severity",
        "User / Email Terkait": "Related User / Email",
        "Rincian / Payload": "Details / Payload",
        "Memuat log keamanan...": "Loading security logs...",
        "Belum ada aktivitas keamanan yang mencurigakan tercatat.": "No suspicious security activity recorded yet.",
        "Webhook alert berhasil disimpan!": "Webhook alert saved successfully!",
        "Webhook alert dinonaktifkan.": "Webhook alert disabled.",
        "Silakan masukkan Webhook URL terlebih dahulu sebelum melakukan test alert.": "Please enter a Webhook URL first before testing alerts.",
        "Sinyal uji coba alert telah dikirim ke Webhook!": "Test alert signal sent to Webhook!",
        "Sentry DSN berhasil disimpan & diinisialisasi!": "Sentry DSN saved & initialized successfully!",
        "Sentry DSN dinonaktifkan.": "Sentry DSN disabled.",
        "Apakah Anda yakin ingin membersihkan riwayat log keamanan lokal?": "Are you sure you want to clear local security log history?",
        "Log keamanan lokal berhasil dibersihkan.": "Local security logs cleared successfully.",
        "Gagal membersihkan log:": "Failed to clear logs:",
        "Gagal membersihkan log: ": "Failed to clear logs: ",

        // --- Backup Data & Pemulihan ---
        "Backup Data": "Data Backup",
        "Backup & Pemulihan Data Perusahaan": "Company Data Backup & Recovery",
        "Buat snapshot cadangan database berkala yang terisolasi untuk mengantisipasi kerusakan data atau pemulihan darurat.": "Create periodic isolated database snapshots to prevent data loss or for emergency recovery.",
        "Download Snapshot Database": "Download Database Snapshot",
        "Cadangkan seluruh data staf, log presensi, shift, dan lokasi kantor tenant Anda dalam format terenkripsi JSON.": "Back up all staff data, attendance logs, shifts, and office locations of your tenant in encrypted JSON format.",
        "Data terisolasi khusus perusahaan aktif (Multi-Tenant safe).": "Data isolated specifically for active company (Multi-Tenant safe).",
        "Format JSON standar, kompatibel untuk restorasi atau arsip cold storage.": "Standard JSON format, compatible for restoration or cold storage archiving.",
        "Buat & Unduh Snapshot Backup": "Create & Download Backup Snapshot",
        "Menyiapkan Snapshot Data...": "Preparing Data Snapshot...",
        "Snapshot database": "Database snapshot",
        "Hanya Admin yang dapat mengunduh backup data.": "Only Admins can download data backups.",
        "Verifikasi & Inspeksi File Backup": "Verify & Inspect Backup File",
        "Pilih file snapshot JSON untuk memeriksa integritas data dan jumlah catatan yang tersimpan.": "Select a JSON snapshot file to check data integrity and stored record counts.",
        "Upload File Snapshot (.json)": "Upload Snapshot File (.json)",
        "File Backup Terverifikasi Valid": "Backup File Verified Valid",
        "File JSON bukan format snapshot AbsensiPro yang valid.": "JSON file is not a valid AbsensiPro snapshot format.",
        "Gagal membaca file JSON: format rusak.": "Failed to read JSON file: corrupted format.",
        "Gagal membuat backup:": "Failed to create backup:",
        "Gagal membuat backup: ": "Failed to create backup: ",
        "Tanggal Dibuat:": "Created Date:",
        "entri": "entries",
        "Log Absen": "Attendance Logs",

        // --- Shift Master & Jadwal ---
        "Kelola jadwal jam kerja & shift untuk seluruh staff di sini.": "Manage working hours & shifts for all staff here.",
        "Jam Kerja": "Working Hours",
        "Jadwal Kerja": "Work Schedule",
        "Toleransi Keterlambatan": "Lateness Tolerance",
        "Toleransi Keterlambatan (menit)": "Lateness Tolerance (minutes)",
        "Staff Terpasang": "Assigned Staff",
        "Atur Shift Staff": "Set Staff Shift",
        "Pilih Shift": "Select Shift",
        "Total jam kerja tetap 8 jam/hari. Jam masuk & jam pulang otomatis mengikuti shift yang dipilih.": "Total working hours remain 8 hrs/day. Clock-in & clock-out times automatically follow the selected shift.",
        "Simpan Shift": "Save Shift",
        "Ubah Jam Kerja": "Edit Working Hours",
        "Perubahan berlaku untuk semua staff yang memakai shift ini.": "Changes apply to all staff assigned to this shift.",
        "Simpan Jam Kerja": "Save Working Hours",
        "Cari nama jam kerja...": "Search work hours name...",

        // --- Kalender Izin / Cuti ---
        "Kalender Izin / Cuti Staff": "Staff Leave / Time Off Calendar",
        "Pantau jadwal izin, cuti, menikah, melahirkan, dan libur seluruh staff.": "Track leave, vacation, marriage, maternity, and holiday schedules for all staff.",
        ...
        "Jum": "Fri",
        "Sab": "Sat",
        "Daftar Pengajuan Izin / Cuti Bulan Ini": "Leave / Time Off Requests This Month",
        "Kategori": "Category",
        "Jumlah Hari": "Number of Days",

        // --- Permintaan Password ---
        "Permintaan Ganti Password": "Password Change Requests",
        "Staff yang diizinkan mengubah password sendiri akan muncul di sini untuk disetujui.": "Staff allowed to request password changes will appear here for approval.",
        "Waktu Pengajuan": "Submission Time",
        "Atur Password Staff": "Set Staff Password",
        "Password Baru (kosongkan jika tidak diubah)": "New Password (leave blank if unchanged)",
        "Izinkan staff ini mengajukan ubah password sendiri": "Allow this staff member to request password changes",

        // --- Lokasi Kantor ---
        "Atur daftar kantor/cabang beserta titik koordinat & radius toleransi. Staff hanya bisa absen jika berada di dalam radius salah satu kantor terdaftar.": "Configure office/branch locations with GPS coordinates & tolerance radius. Staff can only clock in within the radius of a registered office.",
        "Tambah / Edit Kantor": "Add / Edit Office",
        "Nama Kantor / Cabang": "Office / Branch Name",
        "Alamat Lengkap": "Full Address",
        "Berdirilah di lokasi kantor, lalu klik tombol di atas untuk mengisi koordinat otomatis dari GPS perangkat Anda. Atau isi manual di bawah.": "Stand at the office location, then click the button above to auto-fill coordinates from your device's GPS. Or fill manually below.",
        "Radius Maksimal Absen (meter)": "Max Clock-in Radius (meters)",
        "Jarak maksimal (dalam meter) dari titik koordinat kantor ini yang masih dianggap valid untuk absen.": "Maximum distance (in meters) from this office coordinate considered valid for clock-in.",
        "Batal Edit": "Cancel Edit",
        "Daftar Kantor/Cabang": "Office / Branch List",
        "Nama & Alamat": "Name & Address",
        "Koordinat": "Coordinates",
        "Radius": "Radius",
        "Contoh: Kantor Pusat Jakarta": "Example: Jakarta Head Office",
        "Jl. Contoh No. 1, Jakarta": "123 Example Street, Jakarta",

        // --- Cuti Tahunan Staff ---
        "Atur Jatah Cuti Tahunan": "Set Annual Leave Quota",
        "Jatah Cuti (hari / tahun)": "Leave Quota (days / year)",
        "Simpan Jatah Cuti": "Save Leave Quota",
        "Jatah cuti harus berupa angka 0 atau lebih.": "Leave quota must be a number 0 or greater.",

        // --- Modal & Lainnya ---
        "Preview Surat Dokter": "Doctor's Note Preview",
        "Catatan verifikasi (opsional)...": "Verification notes (optional)...",
        "Akun Terkunci Permanen": "Account Permanently Locked",
        "Terlalu banyak percobaan login gagal. Demi keamanan, akun ini dikunci permanen. Buat username & password baru untuk mengakses kembali akun Anda.": "Too many failed login attempts. For security, this account is permanently locked. Create a new username & password to regain access.",
        "ID Staff / Username Lama": "Old Staff ID / Username",
        "Username Baru": "New Username",
        "Pulihkan Akun": "Recover Account",
        "Contoh: EMP-001 atau username lama": "Example: EMP-001 or old username",
        "Username baru": "New username",
        "Password baru (min 4 karakter)": "New password (min 4 characters)",
        "Lupa Password?": "Forgot Password?",
        "Masukkan email yang terdaftar. Kami akan mengirimkan link reset password ke email Anda.": "Enter your registered email. We will send a password reset link to your email.",

        // --- Offline, PWA & Alerts ---
        "Mode Offline Aktif": "Offline Mode Active",
        "Data Offline Tersimpan": "Offline Data Saved",
        "Koneksi internet terputus. Absensi tetap dapat dilakukan dan tersimpan di memori perangkat.": "Internet connection lost. Attendance can still be taken and saved on device storage.",
        "Terdapat data absensi offline yang belum disinkronkan ke server.": "There are offline attendance records not yet synced to the server.",
        "Tidak dapat menyinkronkan: Perangkat masih dalam kondisi offline.": "Cannot sync: Device is still offline.",
        "Tidak ada data absensi offline yang perlu disinkronkan.": "No offline attendance data to sync.",
        "Sinkronisasi selesai:": "Sync completed:",
        "data presensi offline berhasil dikirim ke server.": "offline attendance records sent to server successfully.",
        "Install App": "Install App",
        "Aktifkan Notifikasi": "Enable Notifications",
        "Notifikasi Aktif": "Notifications Enabled",
        "Notifikasi pengingat shift berhasil diaktifkan.": "Shift reminder notifications are enabled.",
        "Izin notifikasi ditolak. Aktifkan notifikasi dari pengaturan browser.": "Notification permission was denied. Enable notifications in browser settings.",
        "Install AbsensiPro": "Install AbsensiPro",
        "Di iPhone/iPad, install lewat Safari: tekan tombol": "On iPhone/iPad, install via Safari: tap the",
        "(Share) di bawah, lalu pilih": "(Share) button below, then select",
        "\"Add to Home Screen\"": "\"Add to Home Screen\"",
        "Mengerti": "Understood",
        "Landmark wajah tidak terdeteksi": "Face landmarks not detected",
        "Wajah terlalu jauh / kecil": "Face is too far / small",
        "Wajah terlihat jelas": "Face clearly visible",
        "Pencahayaan terlalu silau/terang, posisikan kamera menjauhi lampu langsung.": "Lighting is too bright/glaring, please angle camera away from direct light.",
        "<b>Model AI masih dimuat.</b> Mohon tunggu beberapa detik lalu coba lagi.": "<b>AI Model is still loading.</b> Please wait a few seconds and try again.",
        "<b>Wajah tidak terdeteksi!</b> Posisikan wajah Anda tepat di depan kamera.": "<b>Face not detected!</b> Position your face directly in front of the camera.",
        "<b>Wajah terhalang!</b> Pastikan seluruh wajah (mata, hidung, mulut) terlihat jelas dan tidak tertutup tangan/masker/kacamata hitam.": "<b>Face obstructed!</b> Make sure your entire face (eyes, nose, mouth) is clearly visible and not covered by hands/mask/sunglasses.",
        "<b>Pencahayaan kurang mendukung!</b> Sesuaikan pencahayaan ruangan (jangan terlalu gelap/terlalu terang) lalu coba lagi.": "<b>Lighting is insufficient!</b> Adjust the room lighting (not too dark/too bright) and try again.",
        "<b>Lokasi GPS belum terdeteksi!</b> Klik tombol ambil lokasi / izinkan akses lokasi terlebih dahulu.": "<b>GPS location not detected yet!</b> Click Get Location / allow location access first.",
        "<b>Terindikasi Fake GPS/Mock Location!</b> Akurasi lokasi tidak wajar. Nonaktifkan aplikasi fake GPS lalu coba lagi memakai GPS asli perangkat.": "<b>Suspected Fake GPS/Mock Location!</b> Abnormal location accuracy. Disable the fake GPS app and try again with your device's real GPS.",
        "Layanan Google sedang tidak dapat dimuat. Periksa koneksi internet Anda dan coba lagi.": "Google services currently cannot be loaded. Check your internet connection and try again.",
        "Gagal memproses data akun Google. Silakan coba lagi.": "Failed to process Google account data. Please try again.",

        // --- Staff, Admin Panel & Verification Extras ---
        "Klik \"Daftar disini\" di bawah untuk membuat perusahaan & akun admin baru. Login sekarang tersimpan di server (bukan lagi di browser), jadi akun yang sama bisa dipakai login dari perangkat manapun.": "Click \"Sign up here\" below to register your company & new admin account. Login is now stored on the server (not the browser), so the same account can be used from any device.",
        "F&B": "F&B",
        "FREE 1": "FREE 1",
        "Rp 0": "IDR 0",
        "&larr; Kembali pilih paket": "← Back to package selection",
        "Jika Supabase meminta konfirmasi email, cek folder masuk atau spam email Anda, lalu klik link konfirmasinya sebelum login. Atau minta Admin Supabase untuk mematikan fitur konfirmasi email di dashboard.": "If Supabase requires email confirmation, check your inbox or spam folder and click the confirmation link before logging in. Or ask your Supabase Admin to disable email confirmations in dashboard.",
        "Enterprise-Grade Security": "Enterprise-Grade Security",
        "Mulai kelola kehadiran timmu dalam hitungan menit.": "Start managing your team attendance in minutes.",
        "0 antrean offline": "0 offline queue",
        "Online": "Online",
        "Pagi": "Morning",
        "Siang": "Afternoon",
        "Nama: -": "Name: -",
        ...
        "Masuk Hari Ini": "Present Today",
        "Izin / Cuti": "Leave / Vacation",
        "Jam Masuk": "Clock In",
        "Jam Pulang": "Clock Out",
        "Status": "Status",
        "Rekap Staff Ini": "This Staff's Recap",
        "Panel Admin - Kelola User": "Admin Panel - User Management",
        "Manajemen akun staff dan aturan batas waktu operasional.": "Staff account management and operational hours rules.",
        "Tambah Staff Baru": "Add New Staff",
        "ID Anggota / Staff": "Member / Staff ID",
        "Tanggal Masuk Kerja": "Join Date",
        "Shift Kerja": "Work Shift",
        "Shift Pagi (08:00 - 16:00)": "Morning Shift (08:00 - 16:00)",
        "Shift Siang (13:00 - 21:00)": "Afternoon Shift (13:00 - 21:00)",
        "Total jam kerja tetap 8 jam/hari, jam pulang otomatis menyesuaikan shift.": "Total working hours remain 8 hrs/day, clock-out time automatically adjusts to shift.",
        "Password Awal Login": "Initial Login Password",
        "Bisa ditentukan sendiri (min 6 karakter) atau dikosongkan (default:": "Can be custom set (min 6 chars) or left blank (default:",
        "Role Access": "Role Access",
        "HRD": "HRD",
        "Admin": "Admin",
        "Jatah Cuti Tahunan (hari)": "Annual Leave Quota (days)",
        "Jumlah hari cuti tahunan yang didapat staff ini dalam 1 tahun.": "Annual leave days granted to this staff per year.",
        "Simpan Staff": "Save Staff",
        "Daftar Pengguna Terdaftar": "Registered Users List",
        "Nama": "Name",
        "Keamanan Login": "Login Security",
        "Izin Ubah Password": "Change Password Permission",
        "Sisa Cuti Tahunan": "Remaining Annual Leave",
        "Aksi": "Action",
        "Verifikasi Surat Keterangan Dokter": "Doctor's Note Verification",
        "Periksa dan verifikasi surat dokter yang dikirimkan oleh staff untuk pengajuan Sakit.": "Review and verify doctor's notes submitted by staff for Sick leave.",
        "Menunggu": "Pending",
        "Daftar Pengajuan Sakit & Surat Dokter": "Sick Leave & Doctor's Notes List",
        "Keterangan": "Notes",
        "Surat": "Document",
        "Status Verifikasi": "Verification Status",
        "Contoh: ACME01": "Example: ACME01",
        "emailanda@gmail.com": "youremail@gmail.com",
        "EMP-XXX": "EMP-XXX",
        "Ex: Backend Dev": "Ex: Backend Dev",
        "contoh: rafibagas@gmail.com": "example: user@gmail.com",
        "AbsensiPro@2024! (opsional)": "AbsensiPro@2024! (optional)",
        "Anda belum diizinkan Admin untuk mengubah password sendiri.": "You are not permitted by Admin to change password on your own.",
        "Pengajuan ganti password": "Password change request",
        "ditolak.": "rejected.",
        "berhasil diunduh! Simpan file ini di lokasi aman.": "downloaded successfully! Keep this file in a safe location."
    };
